      ...
      body: citas.isEmpty
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Container(
                  margin: const EdgeInsets.symmetric(vertical: 6), // un poco menos margen vertical
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 12), // padding más compacto
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        // Row paciente + estado con icono
                        Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Icon(
                                  enCurso ? Icons.check_circle : Icons.schedule,
                                  color: enCurso ? AppColors.verde : AppColors.fucsia,
                                  size: 20,
                                ),
                        ...
                        const SizedBox(height: 10), // altura un poco más pequeña entre textos
                        Text(
                          'Motivo: ${cita.motivo}',
                          ...
                          children: [
                            ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                backgroundColor: enCurso ? AppColors.verde : AppColors.fucsia,
                                ...
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    final citaEditada = await Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (_) => PantallaEditarCita(cita: cita),
                                      ),
                                    );
                                    if (citaEditada != null && citaEditada is Cita) {
